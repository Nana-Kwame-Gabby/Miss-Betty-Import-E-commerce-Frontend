    ...
    return (
      <div className="flex flex-col items-center justify-center py-24 px-4">
        <div className="bg-white rounded-2xl shadow-sm p-8 max-w-sm w-full text-center">
          <div className="w-14 h-14 border-4 border-[#F2AA25] border-t-transparent rounded-full animate-spin mx-auto mb-4" />
      ...
      <div className="flex flex-col items-center justify-center py-24 px-4">
        <div className="bg-white rounded-2xl shadow-sm p-8 max-w-sm w-full text-center">
          ...
          <div className="flex flex-col gap-3">
            <Link to="/checkout" className="w-full bg-[#F2AA25] text-white font-bold py-3 rounded-2xl hover:opacity-90 transition-opacity text-sm">
              Try Again
            </Link>
            <Link to="/shop" className="w-full border-2 border-[#1e2d3d] text-[#1e2d3d] font-bold py-3 rounded-2xl hover:bg-[#1e2d3d] hover:text-white transition-colors text-sm">
              Back to Shop
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6">
      <div className="bg-white rounded-2xl shadow-sm p-5 text-center mb-4">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-[#1e2d3d] mb-1.5">Payment Successful 🎉</h1>
